...
# Task 1: What are the minimum and maximum weights?
...
# Q3: Average Causal Effect after weighting and truncating
msm <- (svyglm(re78 ~ treat, design = svydesign(~ 1, weights = ~ weight, data=lalonde)))
coef(msm)
confint(msm)

# Q4: Average Causal Effect after weight truncating
